...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "IA que transforma projetos acadêmicos, GitHub, portfólio e estudos em um currículo DEV ATS-friendly, alinhado à vaga de estágio, júnior ou transição para tecnologia — sem inventar experiências." },
      ...
      { name: "twitter:title", content: "CurrículoIA — Currículo DEV para estágio e vaga júnior" },
      { name: "twitter:description", content: "Adapte seu currículo de desenvolvedor à vaga: stack, projetos acadêmicos, GitHub e portfólio organizados por IA, ATS-friendly e sem invenções." },
